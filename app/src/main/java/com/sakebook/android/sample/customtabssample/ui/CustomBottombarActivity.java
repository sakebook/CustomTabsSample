...
public class CustomBottombarActivity extends AppCompatActivity {
    ...
    public static Intent createActivity(Context context) {
        return new Intent(context, CustomBottombarActivity.class);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_custombottombar);
        ...
        findViewById(R.id.launch_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Log.d("CustomTabsSample", "CustomBottombarActivity warm up is ");
                CustomTabsUtil.launchCustomTabsWithBottombar(CustomBottombarActivity.this, URL, null);
            }
        });
